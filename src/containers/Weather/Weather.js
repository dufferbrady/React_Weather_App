...
class weather extends Component {
    ...
    getWeatherHandler = city => {
        ...
        fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=${updatedCity}&APPID=${API_Key}`)
            .then(res => res.json())
            .then(data => {
    ...
    getForecast = () => {
        ...
        const API_key = "4c04be157de57a31223958d6b571bd89"
        fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/forecast?q=${city}&APPID=${API_key}`)
        .then(res => res.json())
        .then(data => {
            console.log(data)
